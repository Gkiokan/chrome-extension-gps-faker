...
const _hoisted_1$3 = { class: "row q-col-gutter-sm q-mb-sm" };
const _hoisted_2$3 = { class: "col" };
const _hoisted_3$3 = { class: "col" };
const _hoisted_4$3 = { class: "row q-col-gutter-sm" };
const _hoisted_5$2 = { class: "col" };
const _hoisted_6 = { class: "" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h3", { class: "q-my-none text-h6 text-weight-light" }, "Neuen Standort anlegen ", -1)),
    createVNode(QInput, {
      outlined: "",
      dense: "",
      modelValue: $data.location.name,
      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.location.name = $event),
      class: "q-mb-sm",
      label: "Name",
      "stack-label": ""
    }, null, 8, ["modelValue"]),
    createBaseVNode("div", _hoisted_1$3, [
      createBaseVNode("div", _hoisted_2$3, [
        createVNode(QInput, {
          outlined: "",
          dense: "",
          modelValue: $data.location.lat,
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.location.lat = $event),
          label: "Lat",
          "stack-label": ""
        }, null, 8, ["modelValue"])
      ]),
      createBaseVNode("div", _hoisted_3$3, [
        createVNode(QInput, {
          outlined: "",
          dense: "",
          modelValue: $data.location.lng,
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.location.lng = $event),
          label: "Lng",
          "stack-label": ""
        }, null, 8, ["modelValue"])
      ])
    ...
    createVNode(QInput, {
      outlined: "",
      dense: "",
      modelValue: $data.autoparse,
      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $data.autoparse = $event),
      label: "Auto Parse (lat,lng)",
      "stack-label": ""
    }, null, 8, ["modelValue"]),
    createVNode(QSpace, { style: { "height": "10px" } }),
...
const Location = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render]]);
const _hoisted_1$2 = { class: "Importer" };
const _hoisted_2$2 = { class: "row q-col-gutter-sm q-mt-sm" };
const _hoisted_3$2 = { class: "col" };
const _hoisted_4$2 = { class: "" };
const _hoisted_5$1 = {
  key: 0,
  class: "q-mt-sm text-red-500"
};
const _sfc_main$2 = {
  __name: "Importer",
  emits: ["done", "reload"],
  setup(__props, { emit: __emit }) {
    ...
    const save = async () => {
      ...
      newLocations.forEach((newLoc) => {
        const exists = list.some(
          (existing) => existing.lat === newLoc.lat && existing.lng === newLoc.lng && existing.name === newLoc.name
        );
        if (!exists) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        _cache[1] || (_cache[1] = createBaseVNode("h3", { class: "q-my-none text-h6 text-weight-light" }, " Importer ", -1)),
        createVNode(QInput, {
          outlined: "",
          type: "textarea",
          dense: "",
...
const _hoisted_1$1 = { class: "Importer" };
const _hoisted_2$1 = { class: "row q-col-gutter-sm q-mt-sm" };
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        _cache[1] || (_cache[1] = createBaseVNode("h3", { class: "q-my-none text-h6 text-weight-light" }, " Exporter ", -1)),
        createVNode(QInput, {
          outlined: "",
          readonly: "",
          type: "textarea",
...
const _hoisted_2 = {
  key: 0,
  class: "flex flex-wrap q-gutter-md"
};
const _hoisted_3 = { class: "q-mr-md text-weight-bold" };
      ...
      return openBlock(), createBlock(QPage, { padding: "" }, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            !isEdit.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
              createVNode(QBtn, {
                dense: "",
                rounded: "",
                "no-caps": "",
                ...
                onClick: _cache[0] || (_cache[0] = ($event) => showNewLocation.value = !showNewLocation.value)
              }),
              createVNode(QBtn, {
                dense: "",
                rounded: "",
                ...
                color: "grey-10",
                label: "Import",
                onClick: _cache[1] || (_cache[1] = ($event) => showImporter.value = !showImporter.value)
              }),
              createVNode(QBtn, {
                dense: "",
                rounded: "",
                ...
                color: "red-10",
                label: "Export",
                onClick: _cache[2] || (_cache[2] = ($event) => openExporter())
              })
            ])) : createCommentVNode("", true),
            showNewLocation.value ? (openBlock(), createBlock(Location, {
              key: 1,
              onDone: _cache[3] || (_cache[3] = ($event) => showNewLocation.value = false),
              onAdd: addNewLocation
            })) : createCommentVNode("", true),
            showImporter.value ? (openBlock(), createBlock(_sfc_main$2, {
              key: 2,
              onDone: _cache[4] || (_cache[4] = ($event) => showImporter.value = false),
              onReload: loadCustomLocations
            })) : createCommentVNode("", true),
            showExporter.value ? (openBlock(), createBlock(_sfc_main$1, {
              key: 3,
              onDone: _cache[5] || (_cache[5] = ($event) => showExporter.value = false),
              ref_key: "exporterRef",
              ref: exporterRef
            }, null, 512)) : createCommentVNode("", true),
            _cache[6] || (_cache[6] = createBaseVNode("h3", { class: "q-mb-none text-h6 text-weight-light" }, "Standorte", -1)),
            !loading.value ? (openBlock(), createBlock(QList, {
              key: 4,
              separator: "",
              class: "q-mb-md"
            }, {
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(locations.value, (item) => {
                  return withDirectives((openBlock(), createBlock(QItem, {
                    ...
                    onClick: ($event) => set(item)
                  }, {
                    default: withCtx(() => [
                      createVNode(QItemSection, { avatar: "" }, {
                        default: withCtx(() => [
                          !isActive(item) ? (openBlock(), createBlock(QIcon, {
                            key: 0,
                            name: "gps_not_fixed"
                      ...
                      createVNode(QItemSection, null, {
                        default: withCtx(() => [
                          ...
                          createBaseVNode("small", null, toDisplayString(item.lat) + " | " + toDisplayString(item.lng), 1)
                        ]),
                        _: 2
                      }, 1024),
                      createVNode(QItemSection, { side: "" }, {
                        default: withCtx(() => [
                          item.removeable ? (openBlock(), createBlock(QBtn, {
                            key: 0,
                            round: "",
                            flat: "",
                            icon: "delete",
                            onClick: withModifiers(($event) => removeLocation(item), ["stop"])
            ...
            debug ? (openBlock(), createElementBlock("pre", _hoisted_4, toDisplayString(selected.value), 1)) : createCommentVNode("", true),
            createVNode(QSpace, { style: { "height": "20px" } })
          ])
        ]),
        _: 1
      });
