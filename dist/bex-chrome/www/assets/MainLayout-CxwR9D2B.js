...
const type = "module";
const scripts = { "test": 'echo "No test specified" && exit 0', "dev": "quasar dev", "build": "quasar build", "postinstall": "quasar prepare" };
const dependencies = { "@quasar/extras": "^1.16.4", "quasar": "^2.16.0", "vue": "^3.5.22", "vue-router": "^4.0.0" };
const devDependencies = { "@quasar/app-vite": "^2.1.0", "autoprefixer": "^10.4.2", "postcss": "^8.4.14" };
const engines = { "node": "^28 || ^26 || ^24 || ^22 || ^20", "npm": ">= 6.13.4", "yarn": ">= 1.21.1" };
const json = {
  name,
  version,
  description,
...
const _hoisted_1 = { class: "text-red-5 q-pl-sm" };
const _sfc_main = {
  __name: "MainLayout",
  setup(__props) {
    ref(false);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(QLayout, { view: "lHh Lpr lFf" }, {
        default: withCtx(() => [
          createVNode(QHeader, { class: "q-px-md bg-dark text-subtitle1" }, {
            default: withCtx(() => [
              createVNode(QToolbarTitle, { class: "text-subtitle2" }, {
                default: withCtx(() => [
                  _cache[0] || (_cache[0] = createTextVNode(" GPS Faker ", -1)),
                  _cache[1] || (_cache[1] = createBaseVNode("span", { class: "text-bold text-grey-6" }, " V2 ", -1)),
                  createBaseVNode("small", _hoisted_1, " v" + toDisplayString(unref(json).version) + "|" + toDisplayString(_ctx.$q.version), 1)
                ]),
                _: 1
              })
            ]),
